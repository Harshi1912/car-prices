...
st.set_page_config(page_title = 'car predictor', 
                          page_icon = 'random', 
                          layout = 'centered', 
...
import datapage
import predictpage
dictionary={'Home Page':homepage,'View Data':datapage,'visualisation':plotpage,'Prediction':predictpage}
st.sidebar.header('CHOOSE ONE')
choice=st.sidebar.radio(' ',list(dictionary.keys()))
dictionary[choice].app(final_cars_df)
